  ...
  <div class="flex">
    ...
    <div class="flex flex-col gap-4">
      <form class="border-2 border-black flex flex-col p-4" @submit.prevent="sendPost(); postTitle = ''">
        <h1 class="text-xl font-bold my-4"> Create a new Sponsor or Publish a Post (Demo Publish)</h1>
        <div>
      ...
      <div class="border-2 border-black flex flex-col p-4 gap-1">
        <h1 class="text-xl font-bold mt-4"> Manage your User </h1>
        <div class="w-full h-1 border-t-2 border-blockblue" />
        <div>
